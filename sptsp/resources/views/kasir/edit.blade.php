...
@section('content')
<form action="{{route('kasir.update')}}" method="post">
    @csrf
    ...
    <div class="card">
        ...
        <div class="card-body">
            <x-adminlte-select name="perkara_id" label="Perkara" data-placeholder="Pilih Perkara!">
                ...
                @if ($pembayaran->perkara_id == $jp->id)
            ...
            <x-adminlte-input name="jenis_pembayaran" label="Jenis Pembayaran" value="{{$pembayaran->jenis_pembayaran}}">
                <x-slot name="prependSlot">
            ...
            <x-adminlte-input name="pemasukan" label="Pemasukan" value="{{$pembayaran->pemasukan}}">
                <x-slot name="prependSlot">
            ...
            <x-adminlte-input name="pengeluaran" label="Pengeluaran" value="{{$pembayaran->pengeluaran}}">
                <x-slot name="prependSlot">
                    <div class="input-group-text text-purple">
                        <i class="fas fa-address-card"></i>
                    </div>
