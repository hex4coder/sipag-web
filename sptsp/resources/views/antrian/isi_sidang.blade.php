            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <x-adminlte-select name="sidang_ke" label="Sidang Ke" data-placeholder="Sidang Ke" value=''>
                            <x-slot name="prependSlot">
                        ...
                        @else
                            <x-adminlte-select name="sidang_ke" label="Sidang Ke" data-placeholder="Sidang Ke" value='{{ $antrian->sidang_ke }}'>
                                <x-slot name="prependSlot">
                                    <div class="input-group-text bg-gradient-info">
                                        <i class="fas fa-bug"></i>
                                    </div>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <x-adminlte-input name="ruang_sidang" label="Ruang Sidang" value="{{$antrian->ruang_sidang}}">
                            <x-slot name="prependSlot">
