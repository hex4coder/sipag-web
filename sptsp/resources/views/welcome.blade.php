    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <img src="logo.png" alt="Logo" width="77px">
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    <a href="https://laravel.com/docs"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">{{$d->jenis}}</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                @foreach ($d->prasyarat as $p)
                                
                                    <p class="mt-2 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">{{$p->syarat}}</p>
